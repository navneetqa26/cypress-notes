...

{
   ...
   btnsignup(signupbtn) 
   {
    ...
    alreadyemail(){
        cy.get('[data-qa="email"]').should("have.value","navneet212@gmail.com")
    }
   ...
   verifyaddressdelivery(){
    ...
    .then((text) => {
      ...
      expect(cleaned).to.include('Mr. Navneet Kumar TCS 123 local street Hoshiarpur Punjab 12345 India +9876543210');
    });   }
  
   verifyaddressbilling(){
